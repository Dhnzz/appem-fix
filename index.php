...
<head>
  ...
  <title>E-Complaint - E-Complaint Landing Page</title>
...
<body>
  ...
  <header id="header">
    <div class="container-fluid">
      ...
      <div class="logo float-left">
        <h1 class="text-light"><a href="index.html"><span>E-Complaint Gorontalo</span></a></h1>
      ...
      <nav class="nav-menu">
        <ul>
          ...
          <li><a href="#why-us">Layanan Kami</a></li>
          <li><a href="#faq">Sering Di Tanyakan</a></li>
  ...
  <!-- ======= Hero Section ======= -->
  <section id="hero">
    <div class="hero-container mt-3">
      <h1>Selamat Datang Di E-Complaint Gorontalo</h1>
      <h2>Website Resmi dari pemerintah Gorontalo untuk pengaduan dan keluhan masyarakat indonesia khususnya yang berada di daerah Gorontalo
      </h2>
      <a href="index2.php" class="btn font-weight-bold mt-3" style ="background-color:#fd680e"> Mulai Pengaduan atau pelaporan </a>
  ...
  <main id="main">
    ...
    <section id="about" class="about">
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-6">
            <img src="assets/img/Utama.png" class="img-fluid" alt="">
          </div>
          <div class="col-lg-6 pt-4 pt-lg-0">
            <h3>E-Complaint Gorontalo</h3>
            <p class="font-italic">
    ...
    <section id="why-us" class="why-us section-bg">
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
            <div class="card">
              <img src="assets/img/WhyUs2.svg" class="card-img-top" alt="...">
              <div class="card-icon">
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
            <div class="card">
              <img src="assets/img/WhyUs3.png" class="card-img-top" alt="...">
              <div class="card-icon">
    ...
    <section id="faq" class="faq">
      <div class="container">
        ...
        <div class="section-title">
          <h2>Sering Di Tanyakan</h2>
        </div>

        <ul class="faq-list">

          <li>
            <a data-toggle="collapse" class="collapsed" href="#faq1">Apakah Web E-Complaint Gorontalo ini? <i class="bx bx-down-arrow-alt icon-show"></i><i class="bx bx-x icon-close"></i></a>
            <div id="faq1" class="collapse" data-parent=".faq-list">
              <p>
                E-Complaint Gorontalo adalah web pengaduan keluhan masyrakat indonesia khususnya di daerah Gorontalo sebagai salah satu sarana bagi setiap Masyarakat Gorontalo sebagai pihak internal sebagai Web untuk melaporkan keluhan anda
              </p>
            </div>
          </li>

          <li>
            <a data-toggle="collapse" href="#faq2" class="collapsed">Apakah bentuk respon yang di berikan kepada pelapor atas pengaduan yang di sampaikan <i class="bx bx-down-arrow-alt icon-show"></i><i class="bx bx-x icon-close"></i></a>
            <div id="faq2" class="collapse" data-parent=".faq-list">
              <p>
                Respon yang diberikan kepada pelapor berupa respon awal (ucapan terima kasih telah melakukan pengaduan) dan status/tindak lanjut pengaduan paling akhir sesuai dengan respon yang telah diberikan oleh pihak penerima pengaduan. Respon terkait dengan status/tindak lanjut pengaduan dapat dilihat dalam history pengaduan E-Complaint Gorontalo itu sendiri.
              </p>
            </div>
          </li>

          <li>
            <a data-toggle="collapse" href="#faq3" class="collapsed">Berapa lama respon atas pengaduan yang di sampaikan? <i class="bx bx-down-arrow-alt icon-show"></i><i class="bx bx-x icon-close"></i></a>
          ...
          <li>
            <a data-toggle="collapse" href="#faq4" class="collapsed">Apakah pengaduan saya selalu mendapatkan respon? <i class="bx bx-down-arrow-alt icon-show"></i><i class="bx bx-x icon-close"></i></a>
            <div id="faq4" class="collapse" data-parent=".faq-list">
              <p>
               Pengaduan yang Anda berikan akan direspon dan tercantum dalam Web E-Complaint Gorontalo ini dan akan terupdate secara otomatis sesuai dengan respon yang telah diberikan oleh pihak penerima pengaduan. Untuk dapat melihat respon yang diberikan, Anda harus Login terlebih dahulu dengan username yang telah Anda registrasikan di web ini dan Anda dapat melihat status pengaduan dalam history pengaduan sesuai dengan nomor register pengaduan yang didapatkan. Sebagai catatan, pengaduan Anda akan lebih mudah ditindaklanjuti apabila memenuhi unsur pengaduan.
              </p>
            </div>
          </li>
        ...
        <div class="row justify-content-center">
          ...
          <div class="col-lg-3 col-md-5 mb-5 mb-md-0">
            <div class="info">
              <div class="address">
                <i class="bx bx-map"></i>
                <p>Jl. Thayeb M Gobel<br>Gorontalo, 96135</p>
              </div>

              <div class="email">
                <i class="bx bx-envelope"></i>
                <p>E-ComplaintGtlo@Gmail.com</p>
              </div>
  ...
  <footer id="footer">
    <div class="container">
      <div class="copyright">
        &copy; Copyright <strong><span>E-Complaint Gorontalo</span></strong>. All Rights Reserved
      </div>
      <div class="credits">
